...
<html>
<head>
    <title>Update Student | Library System</title>
</head>
...
<center>
    ...
    <table width="450" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td align="left">
                <font size="6" color="#0F172A"><b>Update Student</b></font><br>
                <font size="2" color="#64748B">Modify profile details for Student ID: #<%=id%></font>
                <br><br><br>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <form action="../updateStudent" method="post" style="margin:0;">
        ...
        <tr>
            <td>
                <a href="viewStudents.jsp" style="text-decoration:none;">
                    <font size="2" color="#2563EB"><b>← Back to Student List</b></font>
                </a>
            </td>
        </tr>
    </table>
