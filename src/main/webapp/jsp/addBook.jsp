...
<center>
    ...
    <table width="450" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td align="left">
                <font size="6" color="#0F172A"><b>➡️ Add New Book</b></font><br>
                <font size="2" color="#64748B">Expand the library collection</font>
                <br><br><br>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <form action="<%=request.getContextPath()%>/addBook" method="post" style="margin:0;">
                    
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <font size="2" color="#475569"><b>Book Title</b></font><br>
                                <input type="text" name="book_name" placeholder="Ex. The White Tiger" required
                        ...
                        <tr>
                            <td>
                                <font size="2" color="#475569"><b>Author Name</b></font><br>
                                <input type="text" name="author" placeholder="Ex. Aravind Adiga" required
                                style="width:100%; height:42px; border:1px solid #CBD5E1; border-radius:6px; padding:0 12px; margin:8px 0 20px 0; font-size:14px;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <font size="2" color="#475569"><b>Genre / Category</b></font><br>
                                <input type="text" name="category" placeholder="Ex. Literary Fiction"
                                style="width:100%; height:42px; border:1px solid #CBD5E1; border-radius:6px; padding:0 12px; margin:8px 0 20px 0; font-size:14px;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <font size="2" color="#475569"><b>Quantity (Copies)</b></font><br>
                                <input type="number" name="quantity" placeholder="Ex. 10" min="1" required
